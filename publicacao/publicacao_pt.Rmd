...
As 22 variáveis independentes (atributos) são as seguintes:

```{r}
names(parkinsons_updrs)
```

Podemos também visualizar um pequeno sumário das respetivas variáveis independentes através do seguinte comando.
```
summary(m1)
